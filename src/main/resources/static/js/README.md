...
| 32 | `js/32-iri-2km.js` | Avg IRI (2 km · worst lane) layer — 2 km IRI roll-up from `/api/iri-2km/geojson`, coloured by the worse of the CL1 / CR1 lane averages, with a per-bin popup showing both lanes. |
